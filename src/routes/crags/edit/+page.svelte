<script>
	...
	function addImageFilename() {
		cragEditorState.crag.images = [...cragEditorState.crag.images, ''];
	}

	function removeImageFilename(idx) {
		cragEditorState.crag.images = cragEditorState.crag.images.filter((_, i) => i !== idx);
	}
</script>
